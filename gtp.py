...
__all__ = ['FailedCommand', 'GoTextPipe']
...
class GoTextPipe(object):
    def __init__(self, size):
        self.board = b(size)
        args = './katago gtp'
        self.engine = subprocess.Popen(args.split(
        ), universal_newlines=True, stdin=subprocess.PIPE, stdout=subprocess.PIPE, encoding="utf8")
        self.boardsize(size)
        self.turns = 0
